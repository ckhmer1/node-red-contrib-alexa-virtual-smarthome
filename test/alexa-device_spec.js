...
describe('Alexa Device Node', function () {
  ...
  it('should make payload lower case', function (done) { // TODO
    this.timeout(10000);
    var flow = [
      { id: "c1", type: "alexa-adapter", name: "Configurazione", http_path: "alexa", port: "" },
      { id: "n2", type: "helper" },
  ...
  it('should make reponde 200 to Alexa.Discovery /alexa/smarthome post', function (done) {
    this.timeout(10000);
    var flow = [
      { id: "n1", type: "alexa-device", alexa: "c1", name: "Luce cucina", "display_categories": "LIGHT", wires: [["n2"]] },
      { id: "n2", type: "helper" },
      { id: "n3", type: "alexa-device", alexa: "c1", name: "Stampante", "display_categories": "SWITCH", wires: [["n2"]] },
      { id: "c1", type: "alexa-adapter", name: "Nome", http_path: "alexa", port: "2701" }
    ];
    const client_id = "client_id";
    const secret = "secret";
